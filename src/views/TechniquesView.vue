...
const techniques = [
  ...
  },
  {
    ...
    terms: [
      ...
      { name: '虚线箭头', description: '箭头两端共享同一个候选，例如第 1 行第 8 列和第 3 行第 7 列共享候选 1，所以不能同时是 1。' },
      { name: '格内切换', description: '中间格都是双候选格。比如第 1 行第 8 列只有 1、2；如果不能是 2，就只能是 1。' },
      { name: '删除目标', description: '第 1 行第 2 列与第 2 行第 1 列都同时看到两个 9 端点，因此都可以排除 9。' },
    ],
    cells: [
      ...
      { index: 1, candidates: [3, 6, 9], eliminate: [9], role: 'target' },
      { index: 9, candidates: [4, 8, 9], eliminate: [9], role: 'target' },
    ],
  },
  {
    id: 'xyz-wing',
