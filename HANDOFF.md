...
- `scripts/generateHellPoolParallel.mjs`：本地并发铸题工具，启动多个 Node 子进程分片搜索，合并时去重并重新编号；推荐本地命令 `npm run hell:generate:parallel -- --attempts 2000 --target-additions 20 --workers 4`
